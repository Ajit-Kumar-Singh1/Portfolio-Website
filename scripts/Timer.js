...
CountUp.prototype.updateCounter=function(){
    ...
    this.countainer.innerHTML ="<strong>" + this.years + "</strong> <small>" + (this.years == 1? "Years" : "Years") + "</small>" +
        " <strong>" + this.months + "</strong> <small>" + (this.months == 1? "Month" : "Month") + "</small>" +
        " <strong>" + this.days + "</strong> <small>" + (this.days == 1? "Gün" : "days") + "</small>" +
...
window.onload=function(){ new CountUp('May 18, 2020 00:00:00', 'counter'); }